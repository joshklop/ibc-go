...
func (cs ClientState) Initialize(_ sdk.Context, cdc codec.BinaryCodec, clientStore store.KVStore, consState exported.ConsensusState) error {
...
func setClientState(store store.KVStore, cdc codec.BinaryCodec, clientState exported.ClientState) {
