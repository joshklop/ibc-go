...
func (cs ClientState) CheckForMisbehaviour(_ sdk.Context, _ codec.BinaryCodec, _ store.KVStore, clientMsg exported.ClientMessage) bool {
...
func (cs ClientState) verifyMisbehaviour(ctx sdk.Context, cdc codec.BinaryCodec, clientStore store.KVStore, misbehaviour *Misbehaviour) error {
