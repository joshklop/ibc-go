...
func (cs *ClientState) verifyHeader(
	ctx sdk.Context, clientStore store.KVStore, cdc codec.BinaryCodec,
	header *Header,
) error {
...
func (cs ClientState) pruneOldestConsensusState(ctx sdk.Context, cdc codec.BinaryCodec, clientStore store.KVStore) {
...
func (cs ClientState) UpdateStateOnMisbehaviour(ctx sdk.Context, cdc codec.BinaryCodec, clientStore store.KVStore, _ exported.ClientMessage) {
